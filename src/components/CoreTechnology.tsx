    ...
    <section id="technology" className="py-16 sm:py-20 bg-[#F5F2ED]">
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#666] text-base">고객을 단골로 만드는 차별화된 맛</p>
        </div>
        ...
        <div className="flex flex-col gap-4 mb-10">
          ...
          <div className="bg-white rounded-lg p-5 flex items-center gap-4">
            ...
            <div>
              <p className="font-bold text-[#2D2926] text-base mb-1">시즈닝 수령</p>
          ...
          <div className="bg-white rounded-lg p-5 flex items-center gap-4">
            ...
            <div>
              <p className="font-bold text-[#2D2926] text-base mb-1">48시간 저온 숙성</p>
          ...
          <div className="bg-white rounded-lg p-5 flex items-center gap-4">
            ...
            <div>
              <p className="font-bold text-[#2D2926] text-base mb-1">최상의 맛 완성</p>
        ...
        <div className="space-y-4 mb-8">
          <div className="bg-white rounded-lg p-5">
            <p className="font-bold text-[#2D2926] text-base mb-2">차별화된 풍미</p>
            <p className="text-[#666] text-sm leading-relaxed">
              본사의 비법 시즈닝으로 잡내를 완벽히 잡고, 깊은 감칠맛을 구현합니다.
            </p>
          </div>
          <div className="bg-white rounded-lg p-5">
            <p className="font-bold text-[#2D2926] text-base mb-2">누구나 가능한 간편함</p>
            <p className="text-[#666] text-sm leading-relaxed">
        ...
        <div className="bg-[#A6192E] rounded-lg p-5 text-center">
          <p className="text-white/80 text-base mb-1">그 결과</p>
